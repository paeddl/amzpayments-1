...
<p>{l s='Your order on' mod='amzpayments'} <span class="bold">{$shop_name|escape:'htmlall':'UTF-8'}</span> {l s='is complete.' mod='amzpayments'}
	...
	<br /><br />{l s='For any questions or for further information, please contact our' mod='amzpayments'} <a href="{$link->getPageLink('contact-form', true)|escape:'htmlall':'UTF-8'}">{l s='customer support' mod='amzpayments'}</a>.
</p>
